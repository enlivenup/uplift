  ...
  <div class="col-md-4" style="margin-left:220px;">
    <div class="card card-inverse" style="border-color: #333;">
      <div class="card-block">
        ...
        <hr>
        <p>Hi <%=request.getSession().getAttribute("displayname") %> Your have successfully registered ! Please check your email <%=request.getSession().getAttribute("email") %> for the registration confirmation </p> 
      </div>
     </div>
   </div>
 </div>
